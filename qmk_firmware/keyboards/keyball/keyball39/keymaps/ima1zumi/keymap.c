...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_universal(
    ...
    SFT_T(KC_Z)    , KC_X    , TD(TD_C_ESC)  , KC_V           , KC_B         ,                                         KC_N , KC_M         , KC_BTN1 , KC_BTN2 , LT(3,KC_TAB) ,
    SFT_T(KC_COMM) , KC_LCTL , ALT_T(KC_ESC) , CMD_T(KC_LNG2) , LT(1,KC_SPC) , LT(2,KC_LNG1) ,       KC_BSPC , LT(2,KC_ENT) , XXXXXXX      , XXXXXXX , XXXXXXX , KC_DOT
  ),
