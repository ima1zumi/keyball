...
// Tap Dance の動作を定義（1回=kc1、2回=kc2）
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_universal(
    ...
    CTL_T(KC_A)    , KC_S        , KC_D          , CTL_T(KC_F)    , KC_G         ,                                         KC_H , KC_J         , KC_K    , KC_L    , LT(3,KC_MINS),
    SFT_T(KC_Z)    , CTL_T(KC_X) , KC_C          , KC_V           , KC_B         ,                                         KC_N , KC_M         , KC_BTN1 , KC_BTN2 , KC_TAB ,
